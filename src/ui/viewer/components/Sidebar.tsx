  ...
  return (
    <aside className="h-full overflow-y-auto bg-surface-1 border-r border-border flex flex-col">
      ...
      <div className="flex items-center gap-3 px-4 h-14 border-b border-border flex-shrink-0">
        ...
        <div>
          <h1 className="text-[15px] font-bold text-zinc-100 leading-none">Total Recall</h1>
      ...
      <div className="mt-auto px-4 py-4 space-y-2">
        ...
        <div className="flex items-center justify-center gap-3">
          <a href="https://github.com/Auriti-Labs/totalrecall" target="_blank" rel="noopener noreferrer" className="text-zinc-600 hover:text-zinc-400 transition-colors" title="GitHub">
          ...
          <a href="https://auritidesign.it/docs/totalrecall/" target="_blank" rel="noopener noreferrer" className="text-zinc-600 hover:text-zinc-400 transition-colors" title="Documentation">
        ...
        <div className="text-[10px] text-zinc-700 font-mono text-center">Total Recall v{TOTALRECALL_VERSION}</div>
      </div>
    </aside>
  );
}
